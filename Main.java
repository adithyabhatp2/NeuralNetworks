...
//				// train over entire set epoch times
//				double trainAccuracy = -1;
//				for (int epochNum = 1;epochNum <= numEpochs;epochNum++)
//					{
//					trainAccuracy = train(folds, testFoldIndex, singleNode, epochNum);
//					}
//				// test after epoch trainings
//				double testAccuracy = test(folds, testFoldIndex, singleNode, numEpochs);
//				if(debugLevel <= 3)
//					{
...
//			{
		outputLines = new HashMap<Integer, String>();
			...
			for (int testFoldIndex = 0;testFoldIndex < numFolds;testFoldIndex++)
				...
				for (int epochNum = 1;epochNum <= numEpochs;epochNum++)
					{
					double trainAccuracy = train(folds, testFoldIndex, singleNode, epochNum);
					double testAccuracy = test(folds, testFoldIndex, singleNode, epochNum);
					if(debugLevel <= 3)
						{
...
//			}
	...
	public static double train(List<LinkedList<Instance>> folds, int testFoldIndex, ANNode singleNode, int epochNum)
		{
		double accuracy = 0.0;
	...
	public static double test(List<LinkedList<Instance>> folds, int testFoldIndex, ANNode singleNode, int epochNum)
		{
		double accuracy = 0.0;
		int tp = 0, tn = 0, fp = 0, fn = 0;
